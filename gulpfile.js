...
gulp.task('distStyles', function () {
  styles('/Users/alarner/Projects/alarner.github.io/projects/imdb');
});
...
gulp.task('fonts', function () {
  return gulp.src(require('main-bower-files')().concat('app/fonts/**/*'))
    ...
    .pipe(gulp.dest('/Users/alarner/Projects/alarner.github.io/projects/imdb/fonts'));
});
...
gulp.task('clean', require('del').bind(null, ['.tmp', '/Users/alarner/Projects/alarner.github.io/projects/imdb']));
